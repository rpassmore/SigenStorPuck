...
struct GradientConfig {
    int32_t amber_threshold = 2000; // Default: 3 kW turns pure Amber
    int32_t red_threshold   = 5000; // Default: 7 kW turns pure Red
    int32_t blue_threshold  = 2000; // Default: -3kW turns blue
    int32_t green_threshold  = 5000; // Default: -3kW turns blue
};
...
static constexpr uint32_t POWER_COLOUR_BLUE = 0x80E480;  //0080FF; 
...
// static constexpr uint32_t POWER_COLOUR_YELLOW = 0x0080FF; 
// // static constexpr uint32_t POWER_COLOUR_GREEN  = 0x00C800;
